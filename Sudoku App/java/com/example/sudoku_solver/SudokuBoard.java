...
public class SudokuBoard extends AppCompatActivity {
    ...
    public void button() {
        /* Button to go back to Scanner form SudokuBoard */
        Button buttonBackToScanner = findViewById(R.id.buttonFromSudokuBackToScan);
        buttonBackToScanner.setOnClickListener(view -> {
            Intent intentSudokuScanner = new Intent(SudokuBoard.this, Scanner.class);
            finish();
